...
import type { ILootBridgeGovernanceV2 } from './ILootBridgeGovernanceV2';

export class ILootBridgeGovernanceV2__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): ILootBridgeGovernanceV2 {
    return new Contract(
      address,
      _abi,
      signerOrProvider,
    ) as ILootBridgeGovernanceV2;
  }
}
...
const _abi = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct ILootBridgeGovernanceV2.ProposalWithoutVotes',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'enum ILootBridgeGovernanceV2.ProposalState',
        name: '',
        type: 'uint8',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct ILootBridgeGovernanceV2.Vote',
        name: '',
        type: 'tuple',
      },
    ],
