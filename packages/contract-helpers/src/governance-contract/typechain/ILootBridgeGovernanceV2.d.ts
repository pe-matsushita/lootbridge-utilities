...
interface ILootBridgeGovernanceV2Interface extends ethers.utils.Interface {
  functions: {
...
export class ILootBridgeGovernanceV2 extends Contract {
  ...
  interface: ILootBridgeGovernanceV2Interface;
